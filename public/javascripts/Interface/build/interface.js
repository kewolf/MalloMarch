!function (e) {
    if ("object" == typeof exports)module.exports = e(); else if ("function" == typeof define && define.amd)define(e); else {
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.Interface = e()
    }
}(function () {
            ...
            !function () {
                ...
                Interface.Panel = function () {
                    ...
                    Object.defineProperties(this, {
                        'useRelativeSizesAndPositions': {
                            get: function () {
                                return useRelativeSizesAndPositions;
                            },
                            set: function (val) {
                ...
                Interface.Widget = {
                    ...
                    _background: function () {
                        return this.background || this.panel.childBackground;
                    },
                    _stroke: function () {
                        return this.stroke || this.panel.childStroke;
                    },
                    _fill: function () {
                        return this.fill || this.panel.childFill;
                    },

                    _x: function () {
                        return this.panel.useRelativeSizesAndPositions ? Math.floor(this.x * this.panel.width) : this.x;
                    },
                    _y: function () {
                        return this.panel.useRelativeSizesAndPositions ? Math.floor(this.y * this.panel.height) : this.y;
                    },
                    _width: function () {
                        return this.panel.useRelativeSizesAndPositions ? Math.floor(this.width * this.panel.width) : this.width;
                    },
                    _height: function () {
                        return this.panel.useRelativeSizesAndPositions ? Math.floor(this.height * this.panel.height) : this.height;
                    },
                ...
                Interface.HBox = function () {
                    ...
                    Interface.extend(this, {
                            ...
                            proxyPanel: {
                                ...
                                shouldDraw: [],
                                useRelativeSizesAndPositions: true
                            }, // needed for absolute widths / heights which are set in _init call
   ...
   onvaluechange : function() {this.target.note (this.frequency, this.value)},
                    ...
                    Interface.extend(this, {
                            ...
                            play: function (noteNum, duration) {
                                ...
                                if (typeof Gibber !== 'undefined') {
                                    duration = Gibber.Clock.time(duration)
                                }
                                ...
                                if (child) {
                                    child.changeValue()
                                    future(function () {
                                        if (child._value == 1) child.changeValue()
                                    }, duration)
                                }
                            },
                            onkeyup: function (e) {
                            ...
                            onvaluechange: function () {
                                this.values = [Math.pow(2, (this.startnote + 12 * this.octave - 49) / 12) * 261.626, this.value]
                            },
                            ...
                            placeKeys: function () {
                                ...
                                for (var i = 0; i < notes - 1; i++) {
                                    ...
                                    switch (startnote) {
                                        case 1:
                                            points = [{x: 0, y: 0}, {x: .6, y: 0}, {x: .6, y: .625}, {x: 1, y: .625}, {
                                                x: 1,
                                                y: 1
                                            ...
                                            break;
                                        case 2:
                                            points = [{x: .1, y: 0}, {x: .7, y: 0}, {x: .7, y: 1}, {x: .1, y: 1}, {
                                                x: .1,
                                                y: 0
                                            }] //black
                                            ...
                                            break;
                                        case 3:
                                            points = [{x: .2, y: 0}, {x: .8, y: 0}, {x: .8, y: .625}, {
                                                x: 1,
                                                y: .625
                                            }, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: .625}, {x: .2, y: .625}, {x: .2, y: 0}] // mid
                                            textLocation = {x: .5, y: .75}
                                            bg = this._fill()
                                            fg = this._background()
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                            ...
                                            break;
                                        case 4:
                                            points = [{x: .3, y: 0}, {x: .9, y: 0}, {x: .9, y: 1}, {x: .3, y: 1}, {
                                                x: .3,
                                                y: 0
                                            }], //black
                                            ...
                                            break;
                                        case 5:
                                            points = [{x: 1, y: 0}, {x: .4, y: 0}, {x: .4, y: .625}, {x: 0, y: .625}, {
                                                x: 0,
                                                y: 1
                                            }, {x: 1, y: 1}, {x: 1, y: 0}] //right
                                            textLocation = {x: .5, y: .75}
                                            bg = this._fill()
                                            fg = this._background()
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                            ...
                                            break;
                                        case 6:
                                            points = [{x: 0, y: 0}, {x: 0.57142857, y: 0}, {x: 0.57142857, y: .625}, {
                                                x: 1,
                                                y: .625
                                            }, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: 0}] //left
                                            textLocation = {x: .5, y: .75}
                                            bg = this._fill()
                                            fg = this._background()
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                            ...
                                            break;
                                        case 7:
                                            points = [{x: 0.07142857, y: 0}, {x: 0.64285714, y: 0}, {
                                                x: 0.64285714,
                                                y: 1
                                            }, {x: 0.07142857, y: 1}, {x: 0.07142857, y: 0}] //black
                                            textLocation = {x: .3925, y: .5}
                                            bg = this._background()
                                            fg = this._fill()
                                            bounds = [(j - .5) / dist * this.width + this.x, this.y, this.width / dist, .625 * this.height]
                                            ...
                                            break;
                                        case 8:
                                            points = [{x: 0.14285714, y: 0}, {x: 0.71428571, y: 0}, {
                                                x: 0.71428571,
                                                y: .625
                                            }, {x: 1, y: .625}, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: .625}, {
                                                x: 0.14285714,
                                                y: .625
                                            }, {x: 0.14285714, y: 0}], //middle
                                                textLocation = {x: .5, y: .75}
                                            bg = this._fill()
                                            fg = this._background()
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                            ...
                                            break;
                                        case 9:
                                            points = [{x: 0.21428571, y: 0}, {x: 0.78571428, y: 0}, {
                                                x: 0.78571428,
                                                y: 1
                                            }, {x: 0.21428571, y: 1}, {x: 0.21428571, y: 0}] //black
                                            bg = this._background()
                                            fg = this._fill()
                                            bounds = [(j - .5) / dist * this.width + this.x, this.y, this.width / dist, .625 * this.height]
                                            label = this.noteLabels ? keylabel[startnote] : null
                                            break;
                                        case 10:
                                            points = [{x: 0.28571428, y: 0}, {x: 0.85714285, y: 0}, {
                                                x: 0.85714285,
                                                y: .625
                                            }, {x: 1, y: .625}, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: .625}, {
                                                x: 0.28571428,
                                                y: .625
                                            }, {x: 0.28571428, y: 0}], //middle
                                                bg = this._fill()
                                            fg = this._background()
                                            textLocation = {x: .5, y: .75}
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                            ...
                                            break;
                                        case 11:
                                            points = [{x: 0.35714285, y: 0}, {x: 0.92857142, y: 0}, {
                                                x: 0.92857142,
                                                y: 1
                                            }, {x: 0.35714285, y: 1}, {x: 0.35714285, y: 0}], //black
                                                bg = this._background()
                                            fg = this._fill()
                                            textLocation = {x: .6075, y: .5}
                                            bounds = [(j - .5) / dist * this.width + this.x, this.y, this.width / dist, .625 * this.height]
                                            ...
                                            break;
                                        case 12:
                                            points = [{x: 1, y: 0}, {x: 0.42857142, y: 0}, {x: 0.42857142, y: .625}, {
                                                x: 0,
                                                y: .625
                                            }, {x: 0, y: 1}, {x: 1, y: 1}, {x: 1, y: 0}] //right
                                            bg = this._fill()
                                            fg = this._background()
                                            textLocation = {x: .5, y: .75}
                                            bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                                ...
                                if (startnote == 2 || startnote == 4 || startnote == 7 || startnote == 9 || startnote == 11)
                                    var pkeys = new Interface.ButtonV({
                                        points: [{x: .166, y: 0}, {x: .5, y: 0}, {x: .5, y: 1}, {x: .166, y: 1}, {
                                            x: .166,
                                            y: 0
                                        }], //black
                                        target: this.target,
                                    ...
                                    var pkeys = new Interface.ButtonV({
                                        points: [{x: 1, y: 0}, {x: .33, y: 0}, {x: .33, y: .625}, {x: 0, y: .625}, {
                                            x: 0,
                                            y: 1
                                        }, {x: 1, y: 1}, {x: 1, y: 0}], //right
                                        textLocation: {x: .5, y: .75},
                ...
                Interface.XY = function () {
                    ...
                    Interface.extend(this, {
                            ...
                            remove: function () {
                                this.stopAnimation();
                                Interface.widgets.splice(Interface.widgets.indexOf(this), 1);
                            },
                            add: function () {
                            ...
                            mousemove: function (e) {
                                if (this.hitTest(e) && this.activeTouch !== null) {
                                    if (this.activeTouch.lastTouch === null) {
                                        ...
                                        this.activeTouch.velocity = {
                                            x: now.x - this.activeTouch.lastTouch.x,
                                            y: now.y - this.activeTouch.lastTouch.y
                                        };
                ...
                Interface.Paint = function () {
                    Interface.extend(this, {
                            ...
                            animate: function (co) {
                                ...
                                this.timeout = setTimeout(function () {
                                    me.animate()
                                }, point.timestamp - this.prevTimestamp)
                            ...
                            touchmove: function (touch) {
                                if (this.hitTest(touch) && this.activeTouch !== null) {
                                    if (this.isDrawing) {
                                        ...
                                        if (points) {
                                            points.push({
                                                x: touch.x / this._width(),
                                                y: touch.y / this._height(),
                                                timestamp: Date.now() - this.startTime
                                            })
                                            this.draw()
                                        }
                    ...
                    Interface.extend(this, {
                            ...
                            deleteConnection: function (connection) {
                                ...
                                if (this.ondisconnection) {
                                    this.ondisconnection(this.points[connection[0]], this.points[connection[1]])
                                }
