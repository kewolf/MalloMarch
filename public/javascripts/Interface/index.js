        ...
        Interface.extend(this, {
                ...
                placeKeys: function () {
                    ...
                    for (var i = 0; i < notes - 1; i++) {
                        ...
                        switch (startnote) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                points = [{x: .2, y: 0}, {x: .8, y: 0}, {x: .8, y: .625}, {x: 1, y: .625}, {
                                    x: 1,
                                    y: 1
                                }, {x: 0, y: 1}, {x: 0, y: .625}, {x: .2, y: .625}, {x: .2, y: 0}] // mid
                                textLocation = {x: .5, y: .75}
                                bg = this._fill()
                                fg = this._background()
                                bounds = [j / dist * this.width + this.x, this.y, this.width / dist, this.height]
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                points = [{x: 0.14285714, y: 0}, {x: 0.71428571, y: 0}, {x: 0.71428571, y: .625}, {
                                    x: 1,
                                    y: .625
                                }, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: .625}, {x: 0.14285714, y: .625}, {
                                    x: 0.14285714,
                                    y: 0
                                }], //middle
                                    textLocation = {x: .5, y: .75}
                            ...
                            case 9:
                                ...
                                break;
                            case 10:
                                points = [{x: 0.28571428, y: 0}, {x: 0.85714285, y: 0}, {x: 0.85714285, y: .625}, {
                                    x: 1,
                                    y: .625
                                }, {x: 1, y: 1}, {x: 0, y: 1}, {x: 0, y: .625}, {x: 0.28571428, y: .625}, {
                                    x: 0.28571428,
                                    y: 0
                                }], //middle
                                    bg = this._fill()
                    ...
                    if (startnote == 2 || startnote == 4 || startnote == 7 || startnote == 9 || startnote == 11)
                        ...
                        var pkeys = new Interface.ButtonV({
                            points: [{x: 1, y: 0}, {x: .33, y: 0}, {x: .33, y: .625}, {x: 0, y: .625}, {x: 0, y: 1}, {
                                x: 1,
                                y: 1
                            }, {x: 1, y: 0}], //right
                            textLocation: {x: .5, y: .75},
